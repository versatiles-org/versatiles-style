...
export default class Eclipse extends Stylemaker {
	constructor() {
		super('eclipse');
		this
			...
			.addColor('land', '#0b0a0a')
			.addColor('water', '#18181b')
			.addColor('boundary', '#271f2e')
			.addColor('label', '#3d293d')
			.addColor('labelhalo', '#000000')
			.addColor('street', '#000000')
			.addColor('streetoutline', '#1a1a1a')
			.addColor('wood', '#0c120d')
			.addColor('rail', '#281b28')
			.addColor('agriculture', '#120707')
			.addColor('grass', '#171915')
			.addColor('site', '#141619')
			.addColor('building', '#1a0e1a')
			.addColor('foot', '#100613')
	}
	getLayers() {
		...
		return {
			...
			'boundary-country:outline': {
				size: { 2: 2, 10: 6, },
				opacity: { 2: 0, 4: 0.3 },
				color: getColor('land', { darken: 0.05 }),
				lineBlur: 1,
			},
			'boundary-country': {
				size: { 2: 1, 10: 4, },
			...
			'land-{park,garden,vegetation}': {
				color: getColor('grass', { darken: 0.5, saturate: 0.2 }),
				opacity: { 11: 0, 12: 1 },
			},
			'land-agriculture': {
			...
			'land-{commercial,industrial,residential}': {
				color: getColor('land', { lighten: 0.03 }),
				opacity: { 10: 0, 11: 1 },
			},
			...
			'bridge': {
				color: getColor('land', { lighten: 0.01 }),
			},
			...
			'{tunnel-,}street-*:outline': {
				color: getColor('streetoutline'),
				lineJoin: 'round',
				lineCap: 'round',
			},
			'tunnel-street-*': {
				color: getColor('street', { lighten: 0.03 }),
			},
			'tunnel-street-*:outline': {
				color: getColor('streetoutline', { lighten: 0.13 }),
				lineDasharray: [1, 2],
			},
			'bridge-street-*:outline': {
				color: getColor('streetoutline', { lighten: 0.15 }),
			},
			// motorway
			...
			'way-{footway,path,steps}:outline': {
				...
				opacity: { 17: 0, 18: 1 },
				minzoom: 17,
				color: getColor('foot', { lighten: 0.05 }),
			},
			...
			'{tunnel-,bridge-,}transport-{rail,lightrail}': {
				color: getColor('rail', { darken: 0.1 }),
				size: { 8: 1, 12: 1, 15: 2 },
				lineDasharray: [2, 2],
			},
			// bridge
			...
			'label-place-*': {
				color: getColor('label', { rotate: -15, saturate: 0.5, lighten: 0.5 }),
			...
			'label-place-suburb': {
				...
				size: { 11: 11, 13: 14 },
				textTransform: 'uppercase',
				color: getColor('label', { rotate: -30, saturate: 0.5, lighten: 0.5 }),
			},
			'label-place-quarter': {
				minzoom: 13,
				size: { 13: 13 },
				textTransform: 'uppercase',
				color: getColor('label', { rotate: -40, saturate: 0.5, lighten: 0.5 }),
			},
			'label-place-neighbourhood': {
				minzoom: 14,
				size: { 14: 12 },
				textTransform: 'uppercase',
				color: getColor('label', { rotate: -50, saturate: 0.5, lighten: 0.5 }),
			},
