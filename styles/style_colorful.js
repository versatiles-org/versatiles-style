...
export default class Colorful extends ShortbreadStyle {
	...
	constructor() {
		...
		this
			...
			.addColor('land', "#f9f4ee")
			.addColor('water', "#beddf3")
			.addColor('glacier', "#ffffff")
			.addColor('wood', "#66aa44")
			.addColor('grass', "#d8e8c8")
			.addColor('park', "#d9d9a5")
			.addColor('street', "#ffffff")
			.addColor('streetbg', "#cfcdca")
			.addColor('motorway', "#ffcc88")
			.addColor('motorwaybg', "#e9ac77")
			.addColor('trunk', "#ffeeaa")
			.addColor('trunkbg', "#e9ac77")
			.addColor('buildingbg', "#dfdbd7")
			.addColor('building', "#f2eae2")
			.addColor('boundary', "#a6a6c8")
			.addColor('disputed', "#bebccf")
			.addColor('residential', "#eae6e133")
			.addColor('commercial', "#f7deed40")
			.addColor('industrial', "#fff4c255")
			.addColor('foot', "#fbebff")
			.addColor('label', "#333344")
			.addColor('labelHalo', "#ffffffcc")
			.addColor('agriculture', "#f0e7d1")
			.addColor('rail', "#b1bbc4")
			.addColor('subway', "#a6b8c7")
			.addColor('cycle', "#eff9ff")
			.addColor('waste', "#dbd6bd")
			.addColor('burial', "#dddbca")
			.addColor('sand', "#fafaed")
			.addColor('rock', "#e0e4e5")
			.addColor('leisure', "#e7edde")
			.addColor('wetland', "#d3e6db")
			.addColor('symbol', "#66626a")
			.addColor('danger', "#ff0000")
			.addColor('prison', "#fdf2fc")
			.addColor('parking', "#ebe8e6")
			.addColor('construction', "#a9a9a9")
			.addColor('education', "#ffff80") // 10% opacity in style
			.addColor('hospital', "#ff6666") // 10% opacity in style
	}
	generate() {
		...
		return {
			...
			"street-pedestrian-zone": {
				color: getColor('foot', { lighten: 0.02, opacity: 0.75 }),
				opacity: { 14: 0, 15: 1 },
			},
			...
			"marking-oneway{-reverse,}": {
				...
				opacity: { 16: 0, 17: 0.7 },
				font: getFont('regular'), // prevent maputnik from freaking out
			},
