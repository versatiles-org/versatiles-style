...
const $wood           = "#787878";
const $grass          = $graybeard.green;
const $park           = $graybeard.green;
const $street         = "#ffffff";
const $streetbg       = "#cccccc";
const $motorway       = "#d4d4d4";
const $motorwaybg     = "#b0b0b0";
const $trunk          = "#e4e4e4";
const $trunkbg        = "#b0b0b0";
const $buildingbg     = "#dbdbdb";
const $building       = "#ebebeb";
const $boundary       = "#b8b8b8";
const $disputed       = "#c4c4c4";
const $residential    = $graybeard.urban;
const $commercial     = $graybeard.urban;
const $industrial     = $graybeard.urban;
const $foot           = "#f5f5f5";
const $label          = "#3b3b3b";
const $labelHalo      = "#ffffffcc";
const $agriculture    = $graybeard.green;
const $rail           = "#bababa";
const $subway         = "#b8b8b8";
const $cycle          = "#f7f7f7";
const $waste          = $graybeard.green;
const $burial         = $graybeard.green;
const $sand           = "#f2f2f2";
const $rock           = "#e3e3e3";
const $leisure        = $graybeard.urban;
const $wetland        = $graybeard.green;
const $symbol         = "#666666";
const $danger         = "#808080";
const $prison         = $graybeard.urban;
const $parking        = $graybeard.urban;
const $construction   = $graybeard.urban;
const $education      = $graybeard.urban; // 10% opacity in style
const $hospital       = $graybeard.urban; // 10% opacity in style
