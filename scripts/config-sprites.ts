		...
		extras: {
			...
			icon: {
				...
				icons: {
					...
					bee: {
						src: 'versatiles/bee',
						tags: ['pollinator', 'apiary', 'hive', 'honey', 'insect'],
						description: 'A bee',
					},
					bicycle: {
						src: 'maki/bicycle',
						tags: ['bike', 'cycling', 'cycle', 'ride', 'velo'],
					...
					building: {
						src: 'maki/building',
						tags: ['office', 'block', 'premises', 'structure'],
						description: 'A building',
					},
					buoy: {
						src: 'temaki/buoy',
						tags: ['navigation', 'marker', 'sea', 'float', 'nautical'],
						description: 'A buoy',
					},
					bus_stop: {
					...
					camera: {
						src: 'versatiles/camera',
						tags: ['photo', 'photography', 'picture', 'shot'],
					...
					coin: {
						src: 'versatiles/coin',
						tags: ['money', 'cash', 'currency', 'payment', 'change'],
						description: 'A coin',
					},
					compass: {
						src: 'temaki/compass',
					...
					droplet: {
						src: 'maki/water',
						tags: ['water', 'drop', 'rain', 'liquid', 'moisture'],
					...
					fire: {
						src: 'versatiles/fire',
						tags: ['flame', 'wildfire', 'burn', 'blaze', 'hazard'],
						description: 'A fire',
					},
					fire_truck: {
					...
					parking: {
						src: 'maki/parking',
						tags: ['car park', 'park', 'p', 'garage', 'space'],
						description: 'A parking',
					},
					paw: {
						src: 'versatiles/paw',
					...
					rocket: {
						src: 'maki/rocket',
						tags: ['launch', 'space', 'startup', 'fast', 'boost'],
					...
					wind: {
						src: 'versatiles/wind',
						tags: ['breeze', 'gust', 'airflow', 'weather'],
						description: 'Wind flow lines',
					},
					wind_turbine: {
			...
			symbol: {
				...
				icons: {
					...
					chevron: {
						...
						tags: ['angle', 'flow', 'next', 'direction'],
						description: 'A chevron',
					},
					chevron_double: {
