...
const LAND: LandDef[] = [
	// Developed / modified land — OSM Bright's `landuse` fills, drawn lowest.
	{
		...
		color: (c) => c.land.overlay(c.areaResidential),
		appear: 10,
		group: 'land.urban',
	},
	{
		...
		color: (c) => c.land.overlay(c.areaCommercial),
		appear: 10,
		group: 'land.urban',
	},
	{
		...
		color: (c) => c.land.overlay(c.areaIndustrial),
		appear: 10,
		group: 'land.urban',
	},
	{
		...
		color: (c) => c.land.overlay(c.natureAgriculture),
		appear: 10,
		group: 'land.agriculture',
	},
	{ id: 'waste', kinds: ['landfill'], color: (c) => c.land.overlay(c.areaWaste), appear: 10, group: 'land.urban' },
	{
		id: 'burial',
		kinds: ['cemetery', 'grave_yard'],
		color: (c) => c.land.overlay(c.areaBurial),
		appear: 13,
		group: 'land.urban',
	},
	// Natural land cover — OSM Bright's `landcover` fills, drawn over the developed land.
	{
		...
		color: (c) => c.land.overlay(c.natureRock),
		appear: 11,
		group: 'land.rock',
	},
	{ id: 'forest', kinds: ['forest'], color: (c) => c.land.overlay(c.natureWood), appear: 7, group: 'land.forest' },
	{
		id: 'grass',
		kinds: ['grass', 'grassland', 'meadow', 'wet_meadow'],
		color: (c) => c.land.overlay(c.natureGrass),
		appear: 11,
	...
	},
	{
		id: 'vegetation',
		kinds: ['heath', 'scrub'],
		color: (c) => c.land.overlay(c.naturePark),
		appear: 11,
		group: 'land.vegetation',
	},
	{
		...
		color: (c) => c.land.overlay(c.natureWetland),
		appear: 11,
		group: 'land.wetland',
	},
	...
	{ id: 'sand', kinds: ['beach', 'sand'], color: (c) => c.land.overlay(c.natureSand), appear: 10, group: 'land.sand' },
];
