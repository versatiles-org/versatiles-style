...
const propertyDefs: ShortbreadPropertyDef[] = [
	{ parent: 'layer', types: 'background,fill,fill-extrusion,line,symbol', key: 'filter', valueType: 'filter' },
	{ parent: 'layer', types: 'background,fill,fill-extrusion,line,symbol', key: 'maxzoom', valueType: 'number' },
	{ parent: 'layer', types: 'background,fill,fill-extrusion,line,symbol', key: 'minzoom', valueType: 'number' },

	{ parent: 'layout', types: 'background,fill,fill-extrusion,line,symbol', key: 'visibility', valueType: 'enum' },
	...
	{ parent: 'paint', types: 'fill-extrusion', key: 'fill-extrusion-base', valueType: 'number' },
	{ parent: 'paint', types: 'fill-extrusion', key: 'fill-extrusion-color', short: 'color', valueType: 'color' },
	{
		parent: 'paint',
		types: 'fill-extrusion',
		key: 'fill-extrusion-height',
		valueType: 'number',
	},
	{ parent: 'paint', types: 'fill-extrusion', key: 'fill-extrusion-opacity', short: 'opacity', valueType: 'number' },
	{ parent: 'paint', types: 'fill-extrusion', key: 'fill-extrusion-pattern', valueType: 'resolvedImage' },
	{ parent: 'paint', types: 'fill-extrusion', key: 'fill-extrusion-translate-anchor', valueType: 'enum' },
	{ parent: 'paint', types: 'fill-extrusion', key: 'fill-extrusion-translate', valueType: 'array' },
	{ parent: 'paint', types: 'fill-extrusion', key: 'fill-extrusion-vertical-gradient', valueType: 'boolean' },
