...
exports = module.exports = {
	...
	...Object.entries({
		...
		waste: [ "landfill" ],
		park: [ "park", "village_green" ],
		garden: [ "allotments", "garden",	 ],
		burial: [ "cemetery", "grave_yard" ],
		leisure: [ "miniature_golf", "playground", "recreation_ground", "golf_course" ],
	...
	...["capital","state_capital","city","town","village","hamlet","suburb","quarter","neighbourhood",/*"dwelling","farm","island","locality"*/].reduce(function(labels,id){
	...
	...["trunk","primary","secondary","tertiary","unclassified","residential","living_street","pedestrian"].reduce((l,t)=>{
