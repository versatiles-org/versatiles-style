		...
		function processStyling(layer, style) {
			...
			Object.entries(style).map(([key, value]) => {
				...
				switch (property_def.value) {
					case 'color': value = processColor(value); break;
					case 'fonts': value = processFont(value); break;
					case 'formatted': value = processField(value); break;
			...
			function processExpression(value, cbValue) {
				console.log(value);
				throw new Error('processing this kind of expression is not implemented yet')
				process.exit();
			}
